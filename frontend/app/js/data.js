...
window.XLY_ROUTES = [
  {
    ...
    body_md: `## 路线概述\n\n这是一条**一日文化体验线**，模板可套用到江南多座水乡古镇（周庄、乌镇、南浔等意象）。\n\n公开游记常提到：上午水巷/乘船，中午老街小吃，下午手作或市集；雨天石板路湿滑，不宜跨镇赶场。\n\n- 适合第一次走水乡的人\n- 不赶场，步行量中等\n- 预算友好，城际交通另计\n\n> 建议雨天备伞，石板路较滑。\n\n### 延伸阅读\n- [知乎 · 周庄古镇旅游攻略](https://zhuanlan.zhihu.com/p/653569054)\n- [Google 检索：江南水乡古镇攻略](https://www.google.com/search?q=%E6%B1%9F%E5%8D%97%E6%B0%B4%E4%B9%A1%E5%8F%A4%E9%95%87%E6%97%85%E6%B8%B8%E6%94%BB%E7%95%A5)`,
    dining_md: `## 饮食推荐\n\n### 午餐\n- **老街面馆**：本地面 + 时令小菜，人均 40-60 元\n- **河鲜小馆**：清蒸鱼、油爆虾（按季节）\n\n### 茶歇\n- 桂花糕 / 定胜糕\n- 现磨豆浆或青团（视时令）\n\n| 时段 | 建议 | 人均 |\n| --- | --- | --- |\n| 午餐 | 面馆 + 小菜 | ¥40-60 |\n| 下午 | 糕点茶歇 | ¥15-30 |`,
    stay_md: `## 住宿建议\n\n- **当日往返**：最省，适合周边城市出发\n- **古镇客栈**：河景房优先，注意隔音\n- **近郊民宿**：适合想安静过夜的人\n\n> 节假日提前 1-2 周预订。`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 餐饮 | ¥55-90 |\n| 手作体验（可选） | ¥40-80 |\n| 门票/船票（如有） | ¥0-60 |\n| **合计（不含城际）** | **约 ¥100-180 / 人** |`,
    image: "../../assets/routes/jiangnan-day.jpg",
    popularity: 96,
    rating: 4.8,
    likes: 1280,
    price_from: 680,
  ...
  },
  {
    ...
    body_md: `## 路线概述\n\n自然观光向的**一日慢行**，可套用西南梯田/山乡场景（如元阳哈尼梯田意象）。观景与村落对半开，适合想拍风景又不想高强度徒步的人。\n\n公开攻略提示：灌水季（约 12 月—次年 4 月）倒影更好；早晚温差大；观景高峰常在上午。\n\n- 海拔与温差注意加衣\n- 观景台人流高峰：10:00-11:30\n\n### 延伸阅读\n- [知乎 · 元阳梯田3日环线](https://zhuanlan.zhihu.com/p/606005238)\n- [Google 检索：元阳梯田慢行攻略](https://www.google.com/search?q=%E5%85%83%E9%98%B3%E6%A2%AF%E7%94%B0%E6%85%A2%E8%A1%8C%E6%94%BB%E7%95%A5)`,
    dining_md: `## 饮食推荐\n\n- **农家土菜**：时令蔬菜、腊味（按地区）\n- **竹筒饭 / 酸汤**（西南常见）\n\n人均约 **50-90 元**。`,
    stay_md: `## 住宿建议\n\n- 山景民宿（舒适型首选）\n- 村内客栈（更安静）\n\n当日可往返；过夜建议住半山腰观景带。`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 餐饮 | ¥50-90 |\n| 交通接驳 | ¥30-80 |\n| **合计** | **约 ¥220-380 / 人** |`,
    image: "../../assets/routes/terrace-day.jpg",
    popularity: 88,
    rating: 4.7,
    likes: 960,
    price_from: 590,
  ...
  },
  {
    ...
    body_md: `## 路线概述\n\n专为**亲子短途过夜**设计：白天河谷/乡野步道探索，晚上住家庭房，研学强度低。\n\n适合京津冀等城市近郊 1.5-3 小时车程范围。公开亲子游记多强调：平整步道、可分餐餐饮、热水与取暖。\n\n### 延伸阅读\n- [Google 检索：京津冀亲子乡村研学](https://www.google.com/search?q=%E4%BA%AC%E6%B4%A5%E5%86%80%E4%BA%B2%E5%AD%90%E4%B9%A1%E6%9D%91%E7%A0%94%E5%AD%A6%E7%9F%AD%E9%80%94)\n- [知乎检索：亲子乡村研学](https://zhuanlan.zhihu.com/search?type=content&q=%E4%BA%B2%E5%AD%90%E4%B9%A1%E6%9D%91%E7%A0%94%E5%AD%A6)`,
    dining_md: `## 饮食推荐\n\n- 农家宴：炖菜、烙饼、时令蔬菜\n- 儿童友好：少辣、可分餐\n\n人均约 **60-100 元**（含晚餐）。`,
    stay_md: `## 住宿建议\n\n- **家庭房 / 亲子房**优先\n- 确认有热水与取暖（秋冬）\n- 院子可活动的民宿更合适`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 住宿（一晚） | ¥180-280 / 间起 |\n| 餐饮两日 | ¥120-180 / 人 |\n| **合计** | **约 ¥320-480 / 人** |`,
    image: "../../assets/routes/north-valley.jpg",
    popularity: 92,
    rating: 4.6,
    likes: 1105,
    price_from: 720,
  ...
  },
  {
    ...
    body_md: `## 路线概述\n\n高评分**乡村慢住**模板（徽州西递/宏村一类山地古村意象）。第一天沉浸村落，第二天近村山径轻行。\n\n公开短途攻略多建议：不要一天打卡多个镇；巷内安静民宿优于主街喧闹区。\n\n适合想「住下来」而不是赶景点清单的人。\n\n### 延伸阅读\n- [Google 检索：徽州古村短途攻略](https://www.google.com/search?q=%E5%BE%BD%E5%B7%9E%E5%8F%A4%E6%9D%91%E8%A5%BF%E9%80%92%E5%AE%8F%E6%9D%91%E7%9F%AD%E9%80%94%E6%94%BB%E7%95%A5)\n- [马蜂窝检索：徽州](https://www.mafengwo.cn/search/q.php?q=%E5%BE%BD%E5%B7%9E)`,
    dining_md: `## 饮食推荐\n\n- 臭鳜鱼、毛豆腐（按口味选择）\n- 山货小炒、笋干汤\n\n建议人均 **80-130 元**。`,
    stay_md: `## 住宿建议\n\n- 村内精品民宿（白墙马头墙景观）\n- 避开主街喧闹区的巷内房源更安静`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 住宿 | ¥260-450 / 晚 |\n| 餐饮 | ¥80-130 / 人/天 |\n| **合计** | **约 ¥260-420 / 人** |`,
    image: "../../assets/routes/huizhou-day.jpg",
    popularity: 85,
    rating: 4.9,
    likes: 870,
    price_from: 860,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n- 景区外乡村客栈（性价比）\n- 县城酒店（设施更稳）`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 住宿两晚 | ¥360-600 |\n| 餐饮三天 | ¥180-280 |\n| **合计** | **约 ¥680-980 / 人** |`,
    image: "../../assets/routes/northwest-danxia.jpg",
    popularity: 90,
    rating: 4.7,
    likes: 1420,
    price_from: 1280,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n- 设计型民宿或精品酒店\n- 靠近旧城步行圈，方便夜游`,
    cost_md: `## 费用估算\n\n| 项目 | 参考 |\n| --- | --- |\n| 住宿 | ¥500-900 / 晚 |\n| 餐饮 | ¥120-200 / 人/天 |\n| **合计** | **约 ¥900-1400 / 人** |`,
    image: "../../assets/routes/lingnan-market.jpg",
    popularity: 78,
    rating: 4.5,
    likes: 640,
    price_from: 980,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n- 林场改造民宿\n- 乡镇商务酒店（设施更稳）`,
    cost_md: `## 费用估算\n\n合计约 **¥380-620 / 人**（含一晚）。`,
    image: "../../assets/routes/northeast-forest.jpg",
    popularity: 74,
    rating: 4.4,
    likes: 520,
    price_from: 760,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n- 古镇内客栈（有氛围）\n- 镇外连锁酒店（睡眠质量）`,
    cost_md: `## 费用估算\n\n合计约 **¥280-450 / 人**。`,
    image: "../../assets/routes/bashu-town.jpg",
    popularity: 83,
    rating: 4.5,
    likes: 790,
    price_from: 640,
  ...
  },
  {
    ...
    cost_md: `## 费用估算\n\n合计约 **¥260-420 / 人**（含一晚）。`,
    image: "../../assets/routes/jiangnan-night.jpg",
    popularity: 71,
    rating: 4.6,
    likes: 430,
    price_from: 520,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n- 亲子房 + 有院子\n- 靠近观景台 10 分钟车程内`,
    cost_md: `## 费用估算\n\n合计约 **¥450-720 / 人**。`,
    image: "../../assets/routes/terrace-sunrise.jpg",
    popularity: 80,
    rating: 4.5,
    likes: 680,
    price_from: 890,
  ...
  },
  {
    ...
    image: "../../assets/routes/huizhou-mist.jpg",
    popularity: 69,
    rating: 4.7,
    likes: 390,
    price_from: 480,
  ...
  },
  {
    ...
    stay_md: `## 住宿建议\n\n半日线，通常当日往返。`,
    cost_md: `## 费用估算\n\n合计约 **¥120-200 / 人**。`,
    image: "../../assets/routes/lingnan-hall.jpg",
    popularity: 76,
    rating: 4.3,
    likes: 510,
    price_from: 420,
